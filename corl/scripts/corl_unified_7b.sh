...
# *****************  ***************** #
CKPT_PATH=/mnt/bn/wxd-video-understanding/wangxd/models/Janus-Pro-7B
DATA_PATH=/mnt/bn/wxd-video-understanding/wangxd/ULM-R1/data/x2x_rft_16k

task_format=unify
SAVE_DIR=/mnt/bn/wxd-video-understanding/wangxd/ULM-R1/experiments/JanusPro-7B-CoRL-Unified
...
torchrun --nproc_per_node="8" \
    ...
    --deepspeed corl/scripts/zero3_offload.json \
