...
DATA_PATH=/mnt/bn/wxd-video-understanding/wangxd/ULM-R1/data/mcot_r1_mcq_66k

task_format=unify
SAVE_DIR=/mnt/bn/wxd-video-understanding/wangxd/ULM-R1/experiments/JanusPro-1B-CoRL-Unified

reward_funcs="qa_accuracy format"
...
SAVE_PATH=${SAVE_DIR}/RFT16k-MM2T-RFT-mcq-66k-G16-beta004-bs16
mkdir -p $SAVE_PATH
...
torchrun --nproc_per_node="8" \
    ...
    --master_port="12345" \
    corl/open_r1/grpo_janus_mm2t.py \
