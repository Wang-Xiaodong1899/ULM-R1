...
# SAVE_PATH=${SAVE_DIR}/UniEval-QA_G8-bs16-ebs128-lr3e6
# mkdir -p $SAVE_PATH
...
# ******************************************************************** #
# inference
SAVE_PATH=/mnt/bn/wxd-video-understanding/wangxd/ULM-R1/experiments/JanusPro-1B-CoRL-Unified/RFT22k-CycleMatchAccFormat-UniReward-G8-beta004-bs16
N_CHUNKS=8
