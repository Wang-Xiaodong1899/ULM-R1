...
from ttrl.trainer.grpo_trainer_mm2t import JanusProTTGRPOTrainer
from ttrl.rewards.mm2t import mcq_ttrl_reward
reward_funcs_registry = {
    "mcq_ttrl": mcq_ttrl_reward,
}
...
class GRPOScriptArguments(ScriptArguments):
    ...
    reward_funcs: list[str] = field(
        default_factory=lambda: ["mcq_ttrl"],
        metadata={
...
def main(script_args, training_args, model_args):
    ...
    def make_conversation_mm2t(example):
        # ttp = "Answer the question based on the image and your world knowledge."
        # pp = "Answer the question based on the given image and your knowledge."
        # problem = example['problem'].replace(ttp, pp)
