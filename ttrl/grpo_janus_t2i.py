...
from trl import (
    GRPOConfig, ModelConfig, ScriptArguments, TrlParser, get_peft_config
)
from ttrl.trainer.grpo_trainer_t2i import JanusProTTGRPOTrainer
from ttrl.rewards.t2i import t2i_mcq_reward
reward_funcs_registry = {
    "ttrl_cycle_cs": "TTRL_CycleCS",
    "t2i_qa": t2i_mcq_reward,
}
...
class GRPOScriptArguments(ScriptArguments):
    ...
    reward_funcs: list[str] = field(
        default_factory=lambda: ["ttrl_cycle_cs", "t2i_qa"],
        metadata={
